...
public class NovoUsuarioActivity extends AppCompatActivity {
    ...
    private EditText senhaNovoUsarioEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        senhaNovoUsarioEditText = findViewById(R.id.senhaNovoUsuarioEditText);
        mAuth = FirebaseAuth.getInstance();
    }

    public void criarNovoUsuario(View view) {
        String login = loginNovoUsuarioEditText.getText().toString();
        String senha  = senhaNovoUsarioEditText.getText().toString();
